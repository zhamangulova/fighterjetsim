...
namespace Fighter_Jet_Shooting_game
{
    public partial class Form1 : Form
    {
        ...
        private void mainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            if(enemyOne.Top > 500 || enemyTwo.Top > 500 || enemyThree.Top > 500)
            {
                gameOver();
            }
            ...
            if(goRight == true && player.Left < 502)
            {
                player.Left += playerSpeed;
            }
        ...
        private void resetGame()
        {
            ...
            enemyOne.Left = rnd.Next(20, 150);
            enemyTwo.Left = rnd.Next(200, 350);
            enemyThree.Left = rnd.Next(400, 550);

            enemyOne.Top = rnd.Next(0, 200) * -1;
            enemyTwo.Top = rnd.Next(300, 500) * -1;
            enemyThree.Top = rnd.Next(500, 900)*-1;
